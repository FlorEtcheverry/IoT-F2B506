...
public class Server {
	...
	public static void main (String[] args) throws ExecutionException_Exception, InterruptedException_Exception, RequestInvocationException_Exception, MalformedURLException {
		...
		// Confirmation
		//ctrlPoint.saySomething("C抏st la bonne bo顃e, vous pouvez prendre votre dose habituelle");
		...
		// Final announcement
		//ctrlPoint.saySomething("Tr鑣 bien " + markUser.getName() + ". Vous avez gagn� " + newPoints + " points. A demain !");
